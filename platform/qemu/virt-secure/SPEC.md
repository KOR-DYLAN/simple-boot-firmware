...
flash. `-bios boot.bin` starts the CPU at reset address `0x00000000`.
...
| Initial SP | `0x0e040000` | `0x0e040000` |
...
Default allocations are code `[0, 0x10000)`, RO `[0x10000, 0x20000)`,
RW `[0x0e000000, 0x0e010000)`, and stack `[0x0e030000, 0x0e040000)`.
The assembly runtime copies `.data` from its flash LMA to secure SRAM, then
clears BSS and the stack before the first C instruction.
