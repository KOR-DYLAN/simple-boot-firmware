...
#define BOARD_CODE_LIMIT           U(0x02000000)
#define BOARD_RAM_MIN              U(0x0e000000)
#define BOARD_RAM_LIMIT            U(0x0f000000)
...
#define BOOTLOADER1_STACK_END      U(0x0e030000)
#endif
#ifndef BOOTLOADER1_STACK_START
#define BOOTLOADER1_STACK_START    U(0x0e040000)
#endif
#ifndef BOOTLOADER2_CODE_START
#define BOOTLOADER2_CODE_START     U(0x00100000)
#endif
#ifndef BOOTLOADER2_RW_START
#define BOOTLOADER2_RW_START       U(0x0e010000)
#endif
#ifndef BOOTLOADER2_STACK_END
#define BOOTLOADER2_STACK_END      U(0x0e040000)
#endif
#ifndef BOOTLOADER2_STACK_START
#define BOOTLOADER2_STACK_START    U(0x0e050000)
#endif
/* Shared image layout ---------------------------------------------------- */
